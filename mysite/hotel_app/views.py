...
from .serializers import (UserProfileSerializers,CountryListSerializers,CountryDetailSerializers,CityListSerializers,
                          CityDetailSerializers,ServicesSerializers,
                          HotelListSerializers,HotelDetailSerializers,ImageHotelSerializers,RoomSerializers,ImageRoomSerializers,
