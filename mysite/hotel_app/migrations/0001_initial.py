    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(default=18, validators=[django.core.validators.MinValueValidator(18), django.core.validators.MaxValueValidator(75)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('Семейный', 'Семейный'), ('Одноместный', 'Одноместный'), ('Двухместный', 'Двухместный'), ('Люкс', 'Люкс')], max_length=35)),
                ('room_status', models.CharField(choices=[('Свободен', 'Свободен'), ('Забронировано', 'Забронировано')], default='свободен', max_length=25)),
